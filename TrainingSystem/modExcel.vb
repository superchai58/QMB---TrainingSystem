Module modExcel
    Public Sub CopyToExcelDGV(ByVal rst As DataGridView)
        ...
        fldCount = rst.Columns.Count       'superchai add 20231207        
        For iCol = 1 To fldCount
            xlWs.Cells.Select()
            xlWs.Cells.NumberFormatLocal = "@"
            'xlWs.Cells(1, iCol).Value = rst.Fields(iCol - 1).Name
            xlWs.Cells(1, iCol).Value = rst.Columns(iCol - 1).Name      'superchai add 20231207
        Next
        ...
        Else
            ...
            Dim output(rst.Columns.Count * If(rst.NewRowIndex <> -1, rst.Rows.Count - 1, rst.Rows.Count) - 1) As String
            Dim i As Integer = 0
            For Each row As DataGridViewRow In rst.Rows
        ...
        xlapp.Visible = True
        'rst.Close()        superchai comments 20231207
        rst = Nothing
        xlapp = Nothing
        xlsbook = Nothing
    End Sub
