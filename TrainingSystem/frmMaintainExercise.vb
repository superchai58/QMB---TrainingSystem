Public Class frmMaintainExercise
    ...
    Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
        ...
        StrSql = "Exec InsertExerciseData '" & cmbQuestionNO.Text.Trim & "',N'" & QuestionGroup & "',N'" & cmbGroup.Text.Trim & "'," & _
                "N'" & cmbDeptGroup.Text.Trim & "',N'" & cmbDutyGroup.Text.Trim & "',N'" & cmbQuestionType.Text.Trim & "',N'" & txtExercise.Text.Trim & "'," & _
                "N'" & txtAnswerA.Text.Trim & "',N'" & txtAnswerB.Text.Trim & "',N'" & txtAnswerC.Text.Trim & "',N'" & txtAnswerD.Text.Trim & "'," & _
