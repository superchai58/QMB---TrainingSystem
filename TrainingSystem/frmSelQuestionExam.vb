Public Class frmSelQuestionExam
    ...
    Private Sub btnExcel_Click(sender As Object, e As EventArgs) Handles btnExcel.Click
        'superchai add export excel 20231207 (B)
        Dim rst As New ADODB.Recordset

        'StrSql = "Select * from Exercise_Detail Where Question_Group =N" & sq(cmbQuestionGroup.Text.Trim) & " and  Question_Type=N" & sq(cmbQuestionType.Text.Trim)
        StrSql = "exec OP_QryExamContent @ExamNo=" & mExamNo & ",@ExamType=" & sq(mExamType) & ",@QuestionType='Text',@Title='',@BU=" & sq(P_BU)
        rst = Conn.Execute(StrSql)
        If rst.EOF Then
            MsgBox("No data")
            Exit Sub
        ...
        'superchai add export excel 20231207 (E)
    End Sub
End Class