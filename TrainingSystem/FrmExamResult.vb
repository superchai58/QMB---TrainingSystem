Public Class FrmExamResult
    ...
    Private Sub cmdQuery_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdQuery.Click
        ...
        If TStation.ToUpper() = "TRAINING" Then
            StrSql = "exec  OP_QryExamResult_bytime_TEST'" & txtUserID.Text.Trim & "', '" & cmbType.Text.Trim & "','" & TxtExamScheduleID.Text.Trim & "','" & P_BU & "','" & StartTime & "','" & EndTime & "', 'OP'" '0001'0003
        Else
            StrSql = "exec  OP_QryExamResult_bytime_TEST'" & txtUserID.Text.Trim & "', '" & cmbType.Text.Trim & "','" & TxtExamScheduleID.Text.Trim & "','" & P_BU & "','" & StartTime & "','" & EndTime & "', 'IDL'" '0001'0003
        End If
