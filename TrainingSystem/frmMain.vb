...
Public Class frmMain
    Private Sub initMenu()
        ...
        '--superchai add 20231026 (B)
        If TStation.ToUpper() = "TRAINING" Then
            Me.QuerySkillCardResult.Enabled = True
        Else
            Me.QuerySkillCardResult.Enabled = False
        End If
        '--superchai add 20231026 (E)
    ...
    Private Sub mnuQueryQuestion_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuQueryQuestion.Click
        ...
        frmSearchQuestion.mActionType = "Query"
        frmSearchQuestion.MdiParent = Me
    ...
    Private Sub QuerySkillCardResult_Click(sender As Object, e As EventArgs) Handles QuerySkillCardResult.Click
        frmQuerySkillCardResult.MdiParent = Me
        frmQuerySkillCardResult.Show()
    End Sub

    Private Sub mnuOnlineTest_Click(sender As Object, e As EventArgs) Handles mnuOnlineTest.Click
