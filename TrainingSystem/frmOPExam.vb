...
Public Class frmOPExam
    ...
    Private Sub IniQuestionCtrl(ByVal dtExamContent As DataTable)
        ...
        For indexQCurPage = 1 To pageQCnt
            ...
            If ExerciseData(indexQ - 1).PictureName <> "" Then
                ...
                FirstPicture.SizeMode = "3"  'superchai comments                
    ...
    Private Sub ButtonCtrlArrayClick(ByVal sender As Object, ByVal e As EventArgs)
        ...
        box.Location = New System.Drawing.Point((sfrm.Width / 2) - (box.Width / 2), (sfrm.Height / 2) - (box.Height / 2))       'superchai add 20230825
    ...
    Private Sub cmdStart_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdStart.Click
        ...
        StrSql = "Exec OP_QryExamContentOPExam " & mExamNo.ToString & ",'" & ExamType.ToString & "','Text',N" & sq(txtTitle.Text.Trim) & "," & sq(P_BU)     'superchai add 20231016
        rst = Conn.Execute(StrSql)
    ...
    Private Sub cmdFinish_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdFinish.Click
        ...
        If rst("Result").Value.ToString = "0" And rst("Grade").Value.ToString = "Pass" Then
            ...
            If P_FormFlag.ToUpper = "OPExam".ToUpper Then
                ...
                StrSql = "exec OP_QryExamInfo_Test " & sq(txtEmployeeID.Text.Trim) & "," & sq(P_BU) & "" '0001
                rst = Conn.Execute(StrSql)
                If rst.EOF = False Then
                    ...
                    Else
                        ...
                        '------------Warinda add 20230828 (B)------------
                        'Send mail to Engineer and insert SchedulerID by type "Practic"
                        StrSql = "exec SendEmail_PracticeEvaluation " & sq(txtEmployeeID.Text.Trim) & "," & sq(P_BU) & ",N" & sq(txtEmployeeName.Text.Trim) & "," & mScheduleID & "," & mExamNo & ",N" & sq(txtTitle.Text.Trim) & "," & sq(ExamType.ToString)
                        Conn.Execute(StrSql)
                        '------------Warinda add 20230828 (E)------------
                    End If
